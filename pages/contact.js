            ...
            <section class="text-gray-600 body-font relative">
                <div class="container px-5 py-11 mx-auto">
                    <div class="flex flex-col text-center w-full mb-12">
                        ...
                        <p class="lg:w-2/3 mx-auto leading-relaxed text-base">"Have Questions? Contact Us for Expert Guidance!"</p>
                    </div>
                    <div class="lg:w-1/2 md:w-2/3 mx-auto">
                        <div class="flex flex-wrap -m-2">
                            ...
                            <div class="p-2 w-full">
                                <button class="flex mx-auto text-white bg-blue-500 border-0 py-2 px-8 focus:outline-none hover:bg-blue-700 rounded text-lg">Get Assistance</button>
                            </div>
                        </div>
                    </div>
                </div>
